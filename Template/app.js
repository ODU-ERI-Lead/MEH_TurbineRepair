(function () {
    ...
    //UNITY STUFF
    var buildUrl = "Build";
    var loaderUrl = buildUrl + "/WindSimRepair.loader.js";
    var config = {
        dataUrl: buildUrl + "/WindSimRepair.data",
        frameworkUrl: buildUrl + "/WindSimRepair.framework.js",
        codeUrl: buildUrl + "/WindSimRepair.wasm",
        streamingAssetsUrl: "StreamingAssets",
        companyName: "FuzzPhyte",
        productName: "MEH_WindSim",
